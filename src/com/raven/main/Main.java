...
private void login() {
    ...
    try {
        ...
        if (user != null) {
            String undangan = user.getUndangan();
            if (undangan != null) {
                if (undangan.equals("Admin")) {
                    // Pengguna adalah admin
                    this.dispose();
                    new Admin().setVisible(true);
                } else if (undangan.equals("VIP")) {
                    // Pengguna adalah VIP
                    this.dispose();
                    new VIP().setVisible(true);
                } else if (undangan.equals("Biasa")) {
                    // Pengguna adalah pengguna biasa
                    this.dispose();
                    new Biasa().setVisible(true);
                } else {
                    // Pengguna memiliki undangan yang tidak valid
                    showMessage(Message.MessageType.ERROR, "Undangan tidak valid");
                }
            } else {
                // Pengguna tidak memiliki undangan
                showMessage(Message.MessageType.ERROR, "Anda tidak memiliki undangan");
            }
        } else {
            // Gagal login

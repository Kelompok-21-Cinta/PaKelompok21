 ...
 * @author Aditya D
 */
public class DropOff2 extends javax.swing.JFrame {
    ...
    private void updateBiayaEstimasi() {
        ...
        if ("Kilo Gram".equals(selectedBerat)) {
            biaya = berat * 4000; // 4000 per kilogram
        ...
        if ("Reguler".equals(selectedPengiriman)) {
            ...
            estimasi = "5 hari";
            biaya = berat * 2000; // 2000 per kilogram
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DropOff2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
